...
namespace Fabric.Operations.Traversal.Steps {
	...
	public static class TravSteps {
		...
		public static readonly IList<ITravStep> VertexHasList = new List<ITravStep> {
			...
			new TravStepWith<FabFactor, string, FabFactor>("WithIdentorValue", "f_idv"),
		...
		public static readonly IList<ITravStep> EntryList = new List<ITravStep> {
			...
			new TravStepEntryContains<FabTravFactorRoot, FabFactor>("WhereIdentorValueContains", "f_idv"),
			new TravStepEntryWith<FabTravFactorRoot, string, FabFactor>("WithIdentorValue", "f_idv", false),
