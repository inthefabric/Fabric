...
namespace Fabric.Operations.Traversal.Steps {
	...
	public static class TravSteps {
		...
		public static readonly IList<ITravStep> EntryList = new List<ITravStep> {
			...
			new TravStepEntryContains<FabTravFactorRoot, FabFactor>("WhereValueContains", "f_idv"),
			new TravStepEntryWith<FabTravFactorRoot, string, FabFactor>("WithValue", "f_idv", false),
