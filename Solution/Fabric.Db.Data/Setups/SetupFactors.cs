...
namespace Fabric.Db.Data.Setups {
	...
	public class SetupFactors {
		...
		public SetupFactors(DataSet pSet) {
			...
			AddEventor(EventorTypeId.End, 2003, 8);
			AddEventor(EventorTypeId.Start, 2003, 8);
			AddEventor(EventorTypeId.End, 2004, 8);
			AddEventor(EventorTypeId.Start, 2004, 8);
			AddEventor(EventorTypeId.End, 2005, 7);
			AddEventor(EventorTypeId.Start, 2005, 7);
			AddEventor(EventorTypeId.End, 2007, 12);
			AddEventor(EventorTypeId.Start, 2007, 11, 13);
			AddEventor(EventorTypeId.Start, 1999, 8);
			AddEventor(EventorTypeId.End, 2003, 6);
			AddEventor(EventorTypeId.Occur, 2003);
			AddEventor(EventorTypeId.Occur, 2002);
			AddEventor(EventorTypeId.End, 2007, 5);
			AddEventor(EventorTypeId.Occur, 2012, 1, 16, 6, 43);
			AddEventor(EventorTypeId.Occur, 2012, 3, 27, 6, 22);
			AddEventor(EventorTypeId.Occur, 2012, 5, 4, 6, 59);
			AddEventor(EventorTypeId.Occur, 2012, 6, 29, 6, 31);
			AddEventor(EventorTypeId.Start, 1984, 11, 13);
			AddEventor(EventorTypeId.End, 2007, 8, 11);
			AddEventor(EventorTypeId.Start, 2007, 8, 11);
			AddEventor(EventorTypeId.Start, 2012, 4, 8, 13, 5);
			AddEventor(EventorTypeId.End, 2012, 4, 8, 17, 50);
			AddEventor(EventorTypeId.Start, 2012, 4, 08, 17, 23);
			AddEventor(EventorTypeId.Occur, 2012, 5, 26, 17, 57, 0);
			AddEventor(EventorTypeId.Occur, 2012, 5, 26, 20, 0, 1);
