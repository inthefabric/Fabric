...
namespace Fabric.New.Api {
	...
	public class CreateController {
		...
		private readonly object vRoute;


		////////////////////////////////////////////////////////////////////////////////////////////////
		/*--------------------------------------------------------------------------------------------*/
		public CreateController(object pRequest, object pApiCtx, object pOauthTasks, object pRoute) {
		...
		// - Vector.Value  (All)
		// * CreatedByMember  (Internal)
		// * DescriptorRefinesPrimaryWithArtifact  (All)
		// * DescriptorRefinesRelatedWithArtifact  (All)
		// * DescriptorRefinesTypeWithArtifact  (All)
