...
namespace Fabric.Test.FabApiWeb {
	...
	public class TChangeUserPassword : TBaseWebFunc {
		...
		protected override void TestSetUp() {
			...
			MockTasks.Setup(x => x.GetUser(MockApiCtx.Object, vUserId)).Returns(vResultUserId);
		...
		public void Success() {
			...
			MockValidator.Verify(x => x.UserId(vUserId, ChangeUserPassword.UserIdParam), Times.Once());
		...
		public void ErrUserNotFound() {
			MockTasks.Setup(x => x.GetUser(MockApiCtx.Object, vUserId)).Returns((User)null);
