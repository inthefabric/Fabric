...
namespace Fabric.New.Domain {
	...
	public class App : Artifact {
		...
		/*--------------------------------------------------------------------------------------------*/
		public App() {
			VertexType = (byte)VertexDomainType.Id.App;
		}
	...
	public class Artifact : Vertex {
		...
		/*--------------------------------------------------------------------------------------------*/
		public Artifact() {
			VertexType = (byte)VertexDomainType.Id.Artifact;
		}
	...
	public class Class : Artifact {
		...
		/*--------------------------------------------------------------------------------------------*/
		public Class() {
			VertexType = (byte)VertexDomainType.Id.Class;
		}
	...
	public class Email : Vertex {
		...
		/*--------------------------------------------------------------------------------------------*/
		public Email() {
			VertexType = (byte)VertexDomainType.Id.Email;
		}
	...
	public class Factor : Vertex {
		...
		/*--------------------------------------------------------------------------------------------*/
		public Factor() {
			VertexType = (byte)VertexDomainType.Id.Factor;
		}
	...
	public class Instance : Artifact {
		...
		/*--------------------------------------------------------------------------------------------*/
		public Instance() {
			VertexType = (byte)VertexDomainType.Id.Instance;
		}
	...
	public class Member : Vertex {
		...
		/*--------------------------------------------------------------------------------------------*/
		public Member() {
			VertexType = (byte)VertexDomainType.Id.Member;
		}
	...
	public class OauthAccess : Vertex {
		...
		/*--------------------------------------------------------------------------------------------*/
		public OauthAccess() {
			VertexType = (byte)VertexDomainType.Id.OauthAccess;
		}
	...
	public class Url : Artifact {
		...
		/*--------------------------------------------------------------------------------------------*/
		public Url() {
			VertexType = (byte)VertexDomainType.Id.Url;
		}
	...
	public class User : Artifact {
		...
		/*--------------------------------------------------------------------------------------------*/
		public User() {
			VertexType = (byte)VertexDomainType.Id.User;
		}
	...
	public class Vertex : VertexBase {
		...
		/*--------------------------------------------------------------------------------------------*/
		public Vertex() {
			VertexType = (byte)VertexDomainType.Id.Vertex;
		}
