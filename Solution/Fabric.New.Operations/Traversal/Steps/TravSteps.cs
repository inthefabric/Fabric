...
namespace Fabric.New.Operations.Traversal.Steps {
	...
	public static class TravSteps {
		...
		public static readonly IList<ITravStep> VertexHasList = new List<ITravStep> {
			...
			TravStepsCustom.FactorWhereEventorYear<FabFactor, long>("WhereEventorYear", "f_evd"),
			TravStepsCustom.FactorWhereEventorMonth<FabFactor, byte>("WhereEventorMonth", "f_evd"),
			TravStepsCustom.FactorWhereEventorDay<FabFactor, byte>("WhereEventorDay", "f_evd"),
			TravStepsCustom.FactorWhereEventorHour<FabFactor, byte>("WhereEventorHour", "f_evd"),
			TravStepsCustom.FactorWhereEventorMinute<FabFactor, byte>("WhereEventorMinute", "f_evd"),
			TravStepsCustom.FactorWhereEventorSecond<FabFactor, byte>("WhereEventorSecond", "f_evd"),
			...
			TravStepsCustom.VertexWhereTimestamp<FabVertex, long>("WhereTimestamp", "v_ts"),
		...
		public static readonly IList<ITravStep> LinkHasList = new List<ITravStep> {
			TravStepsCustom.AppDefinesMemberWhereTimestamp<FabAppDefinesMember, long>("WhereTimestamp", "pdm_ts"),
			...
			TravStepsCustom.ArtifactUsedAsPrimaryByFactorWhereTimestamp<FabArtifactUsedAsPrimaryByFactor, long>("WhereTimestamp", "apbf_ts"),
			...
			TravStepsCustom.ArtifactUsedAsRelatedByFactorWhereTimestamp<FabArtifactUsedAsRelatedByFactor, long>("WhereTimestamp", "arbf_ts"),
			...
			TravStepsCustom.MemberCreatesArtifactWhereTimestamp<FabMemberCreatesArtifact, long>("WhereTimestamp", "mca_ts"),
			new TravStepWith<FabMemberCreatesArtifact, byte, FabMemberCreatesArtifact>("WithVertexType", "mca_vt"),
			TravStepsCustom.MemberCreatesFactorWhereTimestamp<FabMemberCreatesFactor, long>("WhereTimestamp", "mcf_ts"),
			...
			TravStepsCustom.UserDefinesMemberWhereTimestamp<FabUserDefinesMember, long>("WhereTimestamp", "udm_ts"),
		...
		public static readonly IList<ITravStep> EntryList = new List<ITravStep> {
			...
			new TravStepEntryWhere<FabTravVertexRoot, long, FabVertex>("WhereTimestamp", "v_ts"),
		};
